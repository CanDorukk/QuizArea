...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Stream<List<Map<String, dynamic>>> getMessages() {
    final currentUserUid = _auth.currentUser!.uid;  // Şu anki kullanıcı ID'sini alıyoruz
    final friendUid = widget.friendUid;

    return FirebaseFirestore.instance
        .collection('chats')
        .where('senderId', whereIn: [currentUserUid, friendUid])  // Her iki tarafı da alıyoruz
        .where('receiverId', whereIn: [currentUserUid, friendUid])  // Alıcı ve gönderici her iki tarafı alıyoruz
